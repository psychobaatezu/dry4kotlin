...
class KotlinDuplicateFinderTest {
    ...
    fun reportsStructuralDuplicateCandidatesWithFileAndLineRanges() {
        ...
        val left = writeSource(dir, "Left.kt", """
            package sample
        ...
        """.trimIndent())
        val right = writeSource(dir, "Right.kt", """
            package sample
    ...
    fun excludesGeneratedAndBuildFilesByDefault() {
        val dir = Files.createTempDirectory("dry4kotlin")
        writeSource(dir.resolve("build/generated"), "One.kt", """
            fun alpha(): Int {
    ...
    fun formatsTextOutputWithLineRanges() {
        ...
        assertEquals("DUPLICATE score=0.88 structure=0.88 size=0.97\n  a.kt:10-14\n  b.kt:20-24", Dry4Kotlin.formatCandidate(candidate))
    }
    ...
    private fun writeSource(dir: Path, name: String, text: String): Path {
